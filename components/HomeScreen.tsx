...
import { IconBook, IconChevronRight } from './IconComponents';
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 p-4 font-sans">
      <header className="text-center mb-8">
        <IconBook className="w-16 h-16 mx-auto text-blue-500" />
        <h1 className="text-4xl font-bold mt-4">Bíblia Sagrada App</h1>
      ...
      <footer className="mt-12 text-center text-gray-500 dark:text-gray-400 text-sm">
        <p>&copy; {new Date().getFullYear()} Bíblia Sagrada App. Todos os direitos reservados.</p>
      </footer>
    </div>
  );
};
